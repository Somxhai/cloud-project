...
export default function ProfilePage() {
	...
	const [professorData, setProfessorData] = useState<ProfessorProfile | null>(
		null
	);
	...
	return (
		<div className="p-6 max-w-xl mx-auto space-y-4">
			...
			<div className="bg-white shadow rounded p-4 space-y-2 border">
				<div>
					<strong>ชื่อผู้ใช้:</strong> {info.username}
				</div>
				<div>
					<strong>อีเมล:</strong> {info.email}
				</div>
				<div>
					<strong>บทบาท:</strong> {info.role}
				</div>
			</div>
